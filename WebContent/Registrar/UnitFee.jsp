...
<% 
	...
	ResultSet rs = stmnt.executeQuery("Select Unit_Fee_Code,FORMAT(Unit_Fee_Amount,2) AS AMOU,Unit_Fee_Display_Status from r_unit_fee  where Unit_Fee_Display_Status = 'Active' ");
		while(rs.next()){
			tablebody += "<tr><td>" + ec.decrypt(ec.key, ec.initVector, rs.getString("Unit_Fee_Code"))+"</td><td>"+rs.getString("AMOU")+"</td><td>"; 
		}
