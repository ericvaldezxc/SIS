...
<% 
	...
	ResultSet rs = stmnt.executeQuery("Select * from r_grade_opening ");
		while(rs.next()){
			tablebody += "<tr><td>Grade Opening</td><td>"+rs.getString("Grade_Opening_Open")+"</td><td>"; 
			if(rs.getString("Grade_Opening_Open").equals("Yes"))
				tablebody +=  "<center><a class='btn btn-info gradeopen' href='javascript:;'><i class='fa fa-rotate-left'></i></a><center></td></tr>";
			else
				tablebody +=  "<center><a class='btn btn-danger gradeopen' href='javascript:;'><i class='fa fa-rotate-right'></i></a><center></td></tr>";
		}
...
<t:Registrar title="Grade Opening" from="Grade" to="Grade Opening">
