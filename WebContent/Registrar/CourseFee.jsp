...
<% 
	...
	ResultSet rs = stmnt.executeQuery("Select *,CASE WHEN Course_Fee_YearLevel = 1 THEN 'First Year' WHEN Course_Fee_YearLevel = 1 THEN 'Second Year' WHEN Course_Fee_YearLevel = 1 THEN 'Third Year' ELSE 'Fourth Year' END as yearlvl,(select ifnull(sum(Course_Fee_Item_Amount),0) from r_course_fee_items where Course_Fee_ID = Course_Fee_Item_CourseFeeID and Course_Fee_Item_Display_Status = 'Active') as amo from r_course_fee inner join r_course on Course_Fee_CourseID = Course_ID inner join r_academic_year on Academic_Year_ID = Course_Fee_AcademicYearID");
		while(rs.next()){
			tablebody += "<tr><td>" + ec.decrypt(ec.key, ec.initVector, rs.getString("Academic_Year_Description"))+ "</td><td>"+ec.decrypt(ec.key, ec.initVector, rs.getString("Course_Description"))+"</td><td>"+rs.getString("yearlvl")+"</td><td>"+rs.getString("amo")+"</td><td>"; 
			if(rs.getString("Course_Fee_Display_Status").equals("Active"))
				tablebody += "<center> <a class='btn btn-success edit' data-toggle='modal' data-yearlvl='"+rs.getString("yearlvl")+"' href='#FeeEdit' data-id='"+rs.getString("Course_Fee_ID")+"' data-acadyear='"+ec.decrypt(ec.key, ec.initVector, rs.getString("Academic_Year_Code"))+"' data-course='"+ec.decrypt(ec.key, ec.initVector, rs.getString("Course_Code"))+"'><i class='fa fa-edit'></i></a> <a class='btn btn-danger delete' href='javascript:;'><i class='fa fa-rotate-right'></i></a><center></td></tr>";
			else
...
<t:Registrar title="Course Fee" from="Pre-Enrollment" to="Course Fee">
    ...
    <jsp:body>
    	<script src="../Assets/Registrar/Pre-Enrollment/CourseFee.js"></script>
    	<table class="hidden">
				<tbody id="duplicate">    
					<td  style="width: 40%">
         				${firstCol}
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
	                                    <thead>
	                                        <tr>
	                                            ...
	                                            <th style="width: 100px">Courset</th>
	                        ...
	                        <div class="row" style="padding-left:15px;padding-top:10px">
	                        	<div class="col-lg-12">
		                            ...
		                            <div class="col-lg-6" style="padding-top:10px">
	                        			Year Level
	                        			<select id="yearlvl" class="populate fee" style="width: 290px">
                                      	  ${yearLvlDrp} 
                                    	</select>                      			
		                            </div>
	                    ...
	                    <form method="post" id="form-data">
	                        ...
	                        <div class="row" style="padding-left:15px;padding-top:10px">
	                        	<div class="col-lg-12">
		                            ...
		                            <div class="col-lg-6" style="padding-top:10px">
	                        				Year Level
	                        			<select id="updyearlvl" class="populate fee" style="width: 290px;">
                                      	  ${yearLvlDrp} 
                                    	</select>                      			
		                            </div>
		                            <div class="col-lg-12" style="padding-top:10px">
