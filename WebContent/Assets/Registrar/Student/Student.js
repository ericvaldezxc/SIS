...
//                e.preventDefault();
//                var stname = $(this).closest('tr').children('td:eq(1)').text()
//                var stnum = $(this).closest('tr').children('td:eq(0)').text()
//                $('#schedule-title').html(stname)
//                $.ajax({
//                    type: 'post',
//                    url: 'Controller/Registrar/Student/StudentSchedule',
//                    data: {
//                    	stnum:stnum
//                    },
//                    success: function (result) {
