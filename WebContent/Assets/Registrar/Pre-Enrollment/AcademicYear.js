...
var EditableTable = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $('#editable-sample').on('click','a.makeactive',function(){
           	 var semcode = $(this).closest('tr').children('td:first').text();
           	 swal({
                    title: "Are you sure?",
                ...
                function (isConfirm) {
                    if (isConfirm) {
                		$.ajax({
        					...
        					url:'Controller/Registrar/Pre-Enrollment/AcademicActiveController',
                ...
                function (isConfirm) {
                    if (isConfirm) {
                		$.ajax({
        					...
        					url:'Controller/Registrar/Pre-Enrollment/AcademicYearController',
        					success: function(result){
	    						 swal("Record Added!", "The data is successfully added!", "success");
	                             var aiNew = oTable.fnAddData([codeTxt, descTxt,'Not Used', "<center><a class='btn btn-success edit' data-toggle='modal' href='#Edit' ><i class='fa fa-edit'></i></a> <a class='btn btn-danger delete' href='javascript:;'><i class='fa fa-rotate-right'></i></a></center>", '']);
                ...
                function (isConfirm) {
                    if (isConfirm) {
                		$.ajax({
        					...
        					url:'Controller/Registrar/Pre-Enrollment/SubjectController',
        					success: function(result){
        						 $('#codeTxt').val('') ;
        						 $('#descTxt').val('');
                                 swal({
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $.ajax({
                                type: 'post',
                                url: 'Controller/Registrar/Pre-Enrollment/AcademicTobeactive',
                                data: {
                                	getval: getval
                                },
                                success: function (response) {
