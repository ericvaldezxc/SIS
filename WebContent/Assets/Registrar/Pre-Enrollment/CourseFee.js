    ...
    return {
        ...
        init: function () {
            ...
            $('#addBtn').click(function(e){
                ...
                function (isConfirm) {
                    if (isConfirm) {
                		$.ajax({
        					type:'POST',
        					data:{schoolyear: schoolyear, course: course,yearlvl:yearlvl,type:"Insert",latcode:latcode},
        					url:'Controller/Registrar/PreEnrollment/CourseFee',
        					success: function(result){
                            	$('#mainBody tr').each(function(index,val){
	                        		$.ajax({
	                					...
	                					url:'Controller/Registrar/PreEnrollment/CourseFeeItem',
	                					async: true,
	                             ...
	                             var aiNew = oTable.fnAddData([schoolyear, subjectDrp,yearlvl,$('#totamount').html(), "<center><a class='btn btn-success edit' data-toggle='modal' href='#SubjectEdit' ><i class='fa fa-edit'></i></a> <a class='btn btn-danger delete' href='javascript:;'><i class='fa fa-rotate-right'></i></a></center>", '']);
            ...
            $('#updBtn').click(function(e){
                ...
                function (isConfirm) {
                    if (isConfirm) {
                		$.ajax({
        					type:'POST',
        					data:{subj: subjectDrp, acad: schoolyear,yearlvl:yearlvl,type:"Update",latcode:latcode},
            ...
            $('#editable-sample').on('click','a.edit', function (e) {
                ...
                var sub = $(this).data("course");
                var yearlvl = $(this).data("yearlvl");
        		...
        		$("#updyearlvl").select2("val", yearlvl);
        		
        		
        		$.ajax({
					type:'POST',
					data:{latcode:latcode},
					url:'Controller/Registrar/PreEnrollment/CourseFeeItemView',
					success: function(result){
