            ...
            $('#addBtn').click(function(e){
                ...
                function (isConfirm) {
                    if (isConfirm) {
                		$.ajax({
        					type:'POST',
        					data:{acadyear: schoolyear, fee: feeDrp,amount: amount,type:"Insert",latcode:latcode},
        					url:'Controller/Registrar/PreEnrollment/MandatoryFee',
        					success: function(result){
	    						 swal("Record Added!", "The data is successfully added!", "success");
	                             var aiNew = oTable.fnAddData([schoolyear, course, amount, "<center><a class='btn btn-success edit' data-toggle='modal' href='#SubjectEdit' ><i class='fa fa-edit'></i></a> <a class='btn btn-danger delete' href='javascript:;'><i class='fa fa-rotate-right'></i></a></center>", '']);
