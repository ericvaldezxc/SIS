                 ...
                 function (isConfirm) {
                     if (isConfirm) {
                 		$.ajax({
         					...
         					url:'Controller/Registrar/Pre-Enrollment/SemesterActiveController',
                ...
                swal({
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            $.ajax({
                                type: 'post',
                                url: 'Controller/Registrar/Pre-Enrollment/SemesterTobeactive',
                                data: {
                                	getval: getval
                                },
                ...
                function (isConfirm) {
                    if (isConfirm) {
                		$.ajax({
        					...
        					url:'Controller/Registrar/Pre-Enrollment/SemesterController',
        					success: function(result){
	    						 swal("Record Added!", "The data is successfully added!", "success");
	                             var aiNew = oTable.fnAddData([codeTxt, descTxt,'Inactive', "<center><a class='btn btn-success edit' data-toggle='modal' href='#Edit' ><i class='fa fa-edit'></i></a> <a class='btn btn-danger delete' href='javascript:;'><i class='fa fa-rotate-right'></i></a></center>", '']);
