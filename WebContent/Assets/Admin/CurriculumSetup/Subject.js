        ...
        init: function () {
            ...
            $('#editable-sample').on('click','a.prof',function(){
            	...
            	$.ajax({
					type:'POST',
					data:{latcode:pcode},
					url:'Controller/Admin/Curriculum/SubjectProfileViewController',
            	...
            	$.ajax({
					type:'POST',
					data:{latcode:pcode},
					url:'Controller/Admin/Curriculum/SubjectProfilePrereqViewController',
					success: function(result){
						var item = $.parseJSON(result);
						 $('#prereqbody').html('')
						 var i= 0;
        					...
        					success: function(result){
        						...
        						$('#e9 option:selected').each(function (index, val) {
	            					 $.ajax({
			        					...
			        					url:'Controller/Admin/Curriculum/PrerequisiteController',
			        					success: function(result){
