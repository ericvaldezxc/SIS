  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" action="#" method="POST"">
        ...
        <h2 class="form-signin-heading">PUP QC<br>Student Information System</h2>
        ...
        <div class="login-wrap">
	        <form>
	            ...
	            <button class="btn btn-lg btn-login btn-block" type="button" style="background-color: #8C1C1C" id="loginBtn">Log in</button>
			</form>
        </div>
