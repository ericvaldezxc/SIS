...
<%
	if(session.getAttribute("username") == null || !session.getAttribute("type").equals("Student")){
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
            	<li > 
           		...
           		<li>
	                <a href="Registration.jsp" class="" id="RegistrationBtn">
	                    <i class="fa fa-edit"></i>
	                    <span>Registration</span>
	                </a>
           		</li>
           		<li>
	                <a href="Grade.jsp" class="" id="GradeBtn">
