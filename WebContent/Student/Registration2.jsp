...
<% 
	...
	rs = stmnt.executeQuery("SELECT count(*) as cou FROM `r_academic_year` where Academic_Year_Active_Flag = 'To be Used' ");
	String cou = "";
	while(rs.next()){
	...
	if(cou.equals("0")){
		...
		rs = stmnt.executeQuery("SELECT Academic_Year_Description,Academic_Year_ID FROM `r_academic_year` where Academic_Year_Active_Flag = 'To be Used' ");
		while(rs.next()){
			acadyear = rs.getString("Academic_Year_Description");
			acad = rs.getString("Academic_Year_ID");
	...
	String sem = "";
	rs = stmnt.executeQuery("SELECT Semester_Description FROM `r_semester` where Semester_Active_Flag = 'To be Used' ");
	while(rs.next())
