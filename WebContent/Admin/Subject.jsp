...
<% 
	...
	ResultSet rs = stmnt.executeQuery("Select * from r_subject");
		while(rs.next()){
			...
			ResultSet rs3 = stmnt3.executeQuery("select * from r_prerequisite inner join r_subject on Subject_ID = Prerequisite_Prequisite_SubjectID where Prerequisite_Main_SubjectID = '"+rs.getString("Subject_ID")+"'");
			while(rs3.next()){
...
<t:Admin title="Subject" from="Curriculum Setup" to="Subject">
    ...
    <jsp:body>
    	<script src="../Assets/Admin/CurriculumSetup/Subject.js"></script>
	            ...
	            <div class="modal-content">
	                ...
	                <div class="modal-body">
	                    <form method="post" id="form-data">
	                        <div class="row" style="padding-left:15px;padding-top:10px">
	                        	<div class="col-lg-12">
	                                Code <input type="text" class="form-control" placeholder="ex. INTE 4213" id="codeUpdateTxt">
	                            </div>
	                            <div class="col-lg-6" style="padding-top:10px">
	                            	Prerequisite
		                            <select class="form-control" id="updSubjectDrp" style="width: 300px">
						   				<option value="default" selected="selected" disabled="disabled" data-unit="0">Select a Subject</option>
						   				${subjectDrp}
						   			</select>
	                            </div>
	                            <div class="col-lg-3" style="padding-top:10px">
	                                Lecturer Hours <input type="number" class="form-control" placeholder="ex. 3" id="updunitsTxt" >
	                            </div>
