...
<% 
	...
	ResultSet rs = stmnt.executeQuery("Select * from r_campus");
		while(rs.next()){
			tablebody += "<tr><td>" + ec.decrypt(ec.key, ec.initVector, rs.getString("Campus_Code"))+ "</td><td>"+ec.decrypt(ec.key, ec.initVector, rs.getString("Campus_Name"))+"</td><td>"+ec.decrypt(ec.key, ec.initVector, rs.getString("Campus_Address"))+"</td><td>"; 
			if(rs.getString("Campus_Display_Status").equals("Active"))
...
<t:Admin title="Campus" from="Faculty Setup" to="Campus">
    ...
    <jsp:body>
    	<script src="../Assets/Admin/FacultySetup/Campus.js"></script>
	                ...
	                <div class="modal-body">
	                    <form method="post" id="form-data">
	                        <div class="row" style="padding-left:15px;padding-top:10px">
	                        	<div class="col-lg-12">
	                        		<div class="col-lg-6">
		                                 Code <input type="text" class="form-control" placeholder="ex. NOVA" id="codeTxt" >
		                            </div>
	                        		<div class="col-lg-12" style="padding-top:10px">
		                                 Name <input type="text" class="form-control" placeholder="ex. Quezon City Polytechnic University Main Campus" id="nameTxt" >
		                            </div>
		                        	<div class="col-lg-12" style="padding-top:10px">
		                                Address<textarea class="form-control" placeholder="ex.  San Bartolome, Novaliches, Quezon City" rows="3" style="margin: 0px 202.5px 0px 0px;resize:none" id="addressTxt"></textarea>
		                            </div>		                        	
	                        	</div>
	                        </div>
	                    </form>
