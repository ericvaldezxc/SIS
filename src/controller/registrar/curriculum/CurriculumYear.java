 ...
 */
@WebServlet("/Registrar/Controller/Registrar/Curriculum/CurriculumYear")
public class CurriculumYear extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CurriculumYear() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(type.equals("Insert"))
			sql = "Insert into r_curriculumyear (CurriculumYear_Code,CurriculumYear_Description) values ('"+ec.encrypt(ec.key, ec.initVector, code)+"','"+ec.encrypt(ec.key, ec.initVector, desc)+"')";
