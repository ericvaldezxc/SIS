 ...
 */
@WebServlet("/Registrar/Controller/Registrar/Student/ReturneeNewCurriculum")
public class ReturneeNewCurriculum extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReturneeNewCurriculum() {
        super();
