 ...
 */
@WebServlet("/Admin/Controller/Admin/Faculty/CampusController")
public class CampusController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(type.equals("Insert"))
			sql = "Insert into r_campus (Campus_Code,Campus_Name,Campus_Address) values ('"+ec.encrypt(ec.key, ec.initVector, code)+"','"+ec.encrypt(ec.key, ec.initVector, desc)+"','"+ec.encrypt(ec.key, ec.initVector, address)+"')";
