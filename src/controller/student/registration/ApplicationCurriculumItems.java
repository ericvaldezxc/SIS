 ...
 */
@WebServlet("/Registrar/Controller/Registrar/Application/ApplicationCurriculumItems")
public class ApplicationCurriculumItems extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApplicationCurriculumItems() {
        super();
