 ...
 */
@WebServlet("/Registrar/Controller/Registrar/Application/ApplicationCurriculumItems2")
public class ApplicationCurriculumItems2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApplicationCurriculumItems2() {
        super();
