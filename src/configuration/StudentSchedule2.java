 ...
 */
@WebServlet("/StudentSchedule2")
public class StudentSchedule2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudentSchedule2() {
        super();
