...
(22, '61kU23Mr5BvJPmAbazznCQ==', 'uyRCromTlt0mM0JPmZSLCw==', 'j7ZLMAqZoFl5fYEtFbMfqA==', '09999137023', '2000-02-12', 'LsNsz0O8wBf6lZVbYb4q3w==', 'Male', 'Single', 'Dyil7ixLUdpHXZWqUJB0AQ==', 'uyRCromTlt0mM0JPmZSLCw==', 'uyRCromTlt0mM0JPmZSLCw==', 'Active', '2018-09-19 15:26:50', '2018-09-19 15:45:34'),
...
(10, 10, '8900.00', 'Active', '2018-09-19 15:28:29', '2018-09-19 15:28:29'),
...
--
ALTER TABLE `r_student_application`
  MODIFY `Student_Application_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `r_student_document`
--
ALTER TABLE `r_student_document`
  MODIFY `Student_Document_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT for table `r_student_profile`
--
ALTER TABLE `r_student_profile`
  MODIFY `Student_Profile_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `r_user_account`
  MODIFY `User_Account_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `t_payable_history`
  MODIFY `Payable_History_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `t_students_grade`
  MODIFY `Students_Grade_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `t_student_account`
--
ALTER TABLE `t_student_account`
  MODIFY `Student_Account_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `t_student_taken_curriculum_subject`
  MODIFY `Student_Taken_Curriculum_Subject_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
